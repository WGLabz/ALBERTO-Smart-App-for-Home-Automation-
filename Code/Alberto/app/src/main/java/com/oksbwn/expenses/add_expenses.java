    ...
    void refreshContents(){
        ...
        try {
            ...
            if(c.getCount()!=0 && c!=null){
                ...
                itemPurchaseDate=new String[c.getCount()];
                int i=0;
                for(c.moveToFirst();!c.isAfterLast();c.moveToNext()){
                    ...
                    itemPurchaseDate[i]=c.getString(c.getColumnIndex("currentDate"));
                    i++;
                }
            }
            else
        ...
        for(int i=0;i<itemsName.length;i++){
            ...
            hm.put("item", "  " + itemsName[i]);
            hm.put("price", "  " + itemCost[i]);
            hm.put("date", "  " + itemPurchaseDate[i]);
            aList.add(hm);
        }
        // Keys used in Hashmap
        String[] from = {"item","price","date"};
        // Ids of views in listview_layout
        int[] to = {R.id.item,R.id.price,R.id.date};
