package com.oksbwn.postNotificationsToPC;
...
public class listenToNotifications extends NotificationListenerService {
    ...
    class NLServiceReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getStringExtra("command").equals("clearall")){
                listenToNotifications.this.cancelAllNotifications();
            }
                ...
                sendBroadcast(i1);
                int i=1;
                for (StatusBarNotification sbn : listenToNotifications.this.getActiveNotifications()) {
