...
public class change_alram_settings extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tueCheck=(CheckBox)findViewById(R.id.tueCheck);
        ...
        thuCheck=(CheckBox)findViewById(R.id.thuCheck);
        ...
        setTimInTextBox();
        getActionBar().setTitle("Alram Manager");
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu){
        ...
        if(alramStatus.equalsIgnoreCase("ON"))
            sw.setChecked(true);
        else
            sw.setChecked(false);
    ...
    public void setTimInTextBox(){
        try {
            ...
            alramStatus=jsonObj.getString("status").toString();
