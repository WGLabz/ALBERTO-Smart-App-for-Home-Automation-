...
public class gmail_inbox extends Activity {
    ...
    private void clickedOnUserMail(String bodyMessage,final String emailID) {
        ...
        try {
            ...
            if(Mails.equalsIgnoreCase("failed")){
                ...
                if (noOfNewMails == 0) {
                    ...
                    List<HashMap<String,String>> mailsList = new ArrayList<HashMap<String,String>>();
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(getBaseContext(), mailsList, R.layout.email_listview, from, to);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view,final int position, long id) {
                            try {
                                clickedOnUserMail(mailBody[position],mailIds[position]);
                            } catch (Exception e) {
