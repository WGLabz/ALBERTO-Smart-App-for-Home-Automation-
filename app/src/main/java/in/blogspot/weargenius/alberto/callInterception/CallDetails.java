...
public class CallDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.refresh_calls).setCheckable(false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.refresh_calls) {
            finish();
            startActivity(new Intent(getApplicationContext(), CallDetails.class));
            return true;
        }
